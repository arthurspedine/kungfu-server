...
public class TrainingCenterController {
    ...
    public ResponseEntity<TrainingCenterDetailsDTO> getDetailsFromTrainingCenterId(@PathVariable UUID id) {
        TrainingCenterDetailsDTO details = service.getDetailsById(id);
